...
{
    public class InteropService : Neo.VM.IInteropService
    {
        ...
        {
            var methodname = System.Text.Encoding.UTF8.GetString(method);
            if (!dictionary.TryGetValue(methodname, out Func<ExecutionEngine, bool> func)) return false;
            return func(engine);
        }
